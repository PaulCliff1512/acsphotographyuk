...
$topicStatement->execute(['slug' => 'creatures']);
...
<body>
  ...
  <main>
    ...
    <section class="gallery" aria-label="Creatures in nature gallery">
      <?php if (count($images) === 0): ?>
        <p class="empty">No creature images have been uploaded yet.</p>
      <?php endif; ?>
    ...
    <?php if ($totalPages > 1): ?>
      <nav class="pagination" aria-label="Creatures gallery pages">
